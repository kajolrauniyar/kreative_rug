        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <input type="text" class="form-control" name="name" id="name" value="{{$category->name}}"> @if($errors->has('name'))
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <textarea name="description" id="description" cols="30" rows="10" class="form-control" style="resize: none">{{$category->description}}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
