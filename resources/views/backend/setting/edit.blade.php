...
<div class="row">
    ...
    <form action="{{route('setting.update',$contact->id)}}" class="form form-validate" method="POST">
        @csrf
        @method('PATCH')
        <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('site_name') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->site_name }}" required>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('facebook') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->facebook }}" required>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('tagline') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->tagline }}" required>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('twitter') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->twitter }}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('youtube') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->youtube }}" required>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('website') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->website }}" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group  {{$errors->has('mailbox') ? 'has-error' : ''}}">
                            ...
                            value="{{ $contact->mailbox }}" required>
