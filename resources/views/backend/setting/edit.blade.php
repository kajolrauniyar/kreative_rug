                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group  {{$errors->has('map') ? 'has-error' : ''}}">
                            ...
                            cols="30" rows="5"  style="width: 100%; resize: none;">{{ $contact->map }}</textarea>
                            @if($errors->has('map'))
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group  {{$errors->has('gtag') ? 'has-error' : ''}}">
                            ...
                            cols="30" rows="5"  style="width: 100%; resize: none;">{{ $contact->gtag }}</textarea>
                            @if($errors->has('gtag'))
