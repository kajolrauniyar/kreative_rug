            ...
            <table id="datatable1" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr class="item{{$position->id}}">
                        ...
                        <td><h4>{{$position->name}}</h4></td>
                        <td>
                            <button type="submit" class="btn ink-reaction btn-floating-action btn-sm btn-info " id="edit-modal" style="margin-right: 10px;"
                            data-id="{{$position->id}}" data-name="{{$position->name}}" data-toggle="modal"
                            data-target="#formModal">
                            <i class="fas fa-pencil-alt" aria-hidden="true"></i>
                        </button>
                        <button type="button" class="btn ink-reaction btn-floating-action btn-sm  btn-danger" data-id="{{$position->id}}" data-toggle="modal"
...
<div class="col-lg-4">
    <form class="form" method="POST" action="{{ route('position.store') }}">
        @csrf
        <div class="card">
            <div class="card-head style-primary">
                <header>Create new position</header>
            </div>
