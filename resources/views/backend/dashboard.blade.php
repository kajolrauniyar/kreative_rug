							...
							<ul class="list divider-full-bleed">
								<li class="tile">
									<div class="tile-content">
										<div class="tile-icon">
											<img src="{{ asset('assets/backend/img/avatar9.jpg') }}" alt="" />
										</div>
								...
								<li class="tile">
									<div class="tile-content">
										<div class="tile-icon">
											<img src="{{ asset('assets/backend/img/avatar4.jpg') }}" alt="" />
										</div>
								...
								<li class="tile">
									<div class="tile-content">
										<div class="tile-icon">
											<img src="{{ asset('assets/backend/img/avatar11.jpg') }}" alt="" />
										</div>
								...
								<li class="tile">
									<div class="tile-content">
										<div class="tile-icon">
											<img src="{{ asset('assets/backend/img/avatar7.jpg') }}" alt="" />
										</div>
								...
								<li class="tile">
									<div class="tile-content">
										<div class="tile-icon">
											<img src="{{ asset('assets/backend/img/avatar8.jpg') }}" alt="" />
										</div>
								...
								<li class="tile">
									<div class="tile-content">
										<div class="tile-icon">
											<img src="{{ asset('assets/backend/img/avatar2.jpg') }}" alt="" />
										</div>
