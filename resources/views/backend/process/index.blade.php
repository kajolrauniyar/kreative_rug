            ...
            <table id="datatable1" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr class="item{{$process->id}}">
                        ...
                        <td>
                            <a href="{{ route('process.edit',$process->id) }}" class="btn ink-reaction btn-floating-action btn-sm btn-info ">
                                <i class="fas fa-pencil-alt" aria-hidden="true" style="line-height: 36px;"></i>
                            </a>

                            <button type="button" class="btn ink-reaction btn-floating-action btn-sm  btn-danger" data-id="{{$process->id}}" data-toggle="modal"
        ...
        <form action="{{ route('process.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-head style-primary">
                    <header>Create new process</header>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <label for="title">Title</label> @if ($errors->has('title'))
